...
* `population` - number of people in this region. This varies over time. The data source uses 3 month data, which we linearly interpolate. See `08-population-data-cleaner.ipynb` and `09-population-weather-merger.ipynb`.
