...
\input{Tables/summary-stas}
\input{Tables/Main-DiD-Results}
\input{Tables/Main-DDD-Results}
\input{Tables/DDD-WO-Controls}
\input{Tables/DDD-ln-Results}
\input{Tables/DDD-Last-5-years}
\input{Tables/04-sunrise-sunset-emissions}

\FloatBarrier
\input{Frontbackmatter/DataColumns}

\input{Frontbackmatter/DataWranglingExplanation}
